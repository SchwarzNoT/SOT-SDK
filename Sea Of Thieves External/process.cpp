...
//MS
uintptr_t GNames = 0x7fef9e0;

//STEAM
//uintptr_t GNames = 0x8735490;
uintptr_t GObjects = 0x64A0090;
...
namespace util {
    ...
    bool init() {
        ...
        procID = getProcID("SoTGame.exe");
        if (procID) {

            modBase = GetModuleBaseAddress(procID, "SoTGame.exe");
            ...
            //MS
           targetWindow = FindWindow("ApplicationFrameWindow", "Sea of Thieves");

            //STEAM
           // targetWindow = FindWindow("UnrealWindow", "Sea of Thieves");
