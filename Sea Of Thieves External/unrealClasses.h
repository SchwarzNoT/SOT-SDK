...
class AMermaid : public AFortPawn {

public: 

	AMermaid(uintptr_t baseAddy);
...
class ANPC : public AFortPawn {

public:

	ANPC(uintptr_t baseAddy);
...
class AFauna : public AFortPawn {

public:

	AFauna(uintptr_t baseAddy);
...
extern std::vector<AFortPawn> targetPawns;
extern std::vector<AFortPawn> enemyPawns;
